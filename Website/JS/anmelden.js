// Variablen auf Standard bringen
alertBoxHIDDEN();
infoOFalertsHINWEG();
...
// Alert box verstecken / hervorbringen
...
//  Input Felder Ausgefüllt? Check Check
function InputFelderAusgefuelltChecker() {
  var nameInput = document.getElementById("fname").value;
  var nameInput2 = document.getElementById("passwort").value;
  var nameInput3 = document.getElementById("kuerzel").value;
  if (
    nameInput.length !== 0 &&
    nameInput2.length !== 0 &&
    nameInput3.length !== 0
  ) {
    regestrierenDARF = true;
...
function check3() {
  ...
  if (
    ...
    return keineDatenAngegeben();
  }
  check();
}

// MySQL und Hauptserver testen ob online
...
// Anmeldedaten verschicken prepare
...
function anmeldeDatenFalsch() {
  ...
  document.getElementById("myBar").style.visibility = "visible";
  document.getElementById("alertError").innerHTML =
    "Anmeldedaten Falsch! Überprüfe das Passwort / den Benutzernamen";
  document.getElementById("ErrorAlert").style.zIndex = "10";
  document.getElementById("kuerzel").style.border = "1px solid black";
  document.getElementById("passwort").style.border = "1px solid red";
  document.getElementById("fname").style.border = "1px solid red";
  ...
  playAudio3();
  mitteilungINSERT(
    (mittelungGRUND = "Anmeldedaten sind Falsch"),
    (warnstufe = "Warnung"),
  );
}

// Unbekanter Server Fehler
function serverERROR() {
  ...
  playAudio();
  mitteilungINSERT(
    (mittelungGRUND = "Error 500, Unbenkannter Server Fehler"),
    (warnstufe = "Kritisch"),
  );
}
...
function anmeldeDatenRichtig() {
  ...
  document.getElementById("myBar").style.visibility = "visible";
  document.getElementById("alertError").innerHTML =
    "Erfolg, Anmeldedaten korrekt! Weiterleitung erfolgt gleich...";
  document.getElementById("ErrorAlert").style.zIndex = "10";
  backgroundCOLOR3();
  move();
  playAudio2();
...
function keineDatenAngegeben() {
  ...
  playAudio3();
  mitteilungINSERT(
    (mittelungGRUND = "Keine Daten Angegeben"),
    (warnstufe = "Warnung"),
  );
  loggingINFO();
}
...
function keineDatenAngegebenKUERZEL() {
  ...
  playAudio3();
  mitteilungINSERT(
    (mittelungGRUND = "Keine Kürzel Angegeben"),
    (warnstufe = "Warnung"),
  );
}
...
function PasswortIstPflicht() {
  ...
  playAudio3();
  mitteilungINSERT(
    (mittelungGRUND = "Keine Passwort Angegeben"),
    (warnstufe = "Warnung"),
  );
}
...
function PasswortZuLang() {
  document.getElementById("alertError").innerHTML =
    "Das Passwort ist zu Lang, maximal 40 Buchstaben / Zahlen sind erlaubt";
  document.getElementById("passwort").style.border = "1px solid red";
  backgroundCOLOR2();
  alertBoxVISIBLE();
  move();
...
function BenutzernameIstPflicht() {
  ...
  playAudio3();
  mitteilungINSERT(
    (mittelungGRUND = "Keinen Benutzernamen Angegeben"),
    (warnstufe = "Warnung"),
  );
}
...
function BenutzernameZuLang() {
  document.getElementById("alertError").innerHTML =
    "Der Benutzername ist zu Lang, maximal 40 Buchstaben / Zahlen sind erlaubt";
  document.getElementById("fname").style.border = "1px solid red";
  backgroundCOLOR2();
  alertBoxVISIBLE();
  move();
...
function BenutzernameZuKurz() {
  ...
  playAudio3();
  mitteilungINSERT(
    (mittelungGRUND = "Benutzername ist zu kurz!"),
    (warnstufe = "Warnung"),
  );
}
...
function kuerzelPFLICHT() {
  ...
  playAudio3();
  mitteilungINSERT(
    (mittelungGRUND = "Kein Kürzel Angegeben"),
    (warnstufe = "Warnung"),
  );
}
...
function kuerzelZuLang() {
  document.getElementById("alertError").innerHTML =
    "Der Kürzel ist zu Lang, maximal 5 Buchstaben / Zahlen sind erlaubt";
  document.getElementById("kuerzel").style.border = "1px solid red";
  backgroundCOLOR2();
  alertBoxVISIBLE();
  move();
  playAudio3();
  mitteilungINSERT(
    (mittelungGRUND = "Kürzel ist zu lang!"),
    (warnstufe = "Warnung"),
  );
}
...
function kuerzelZuKurz() {
  document.getElementById("alertError").innerHTML =
    "Der Kürzel ist zu Kurz, minimum 2 Buchstaben / Zahlen sind erlaubt";
  document.getElementById("kuerzel").style.border = "1px solid red";
  backgroundCOLOR2();
  alertBoxVISIBLE();
  move();
  playAudio3();
  mitteilungINSERT(
    (mittelungGRUND = "Kürzel ist zu kurz!"),
    (warnstufe = "Warnung"),
  );
}
