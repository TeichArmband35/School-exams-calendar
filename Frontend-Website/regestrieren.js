...
regestrierenDARF = 0;
console.log("REG: "+regestrierenDARF);
linkEHRE = 0;
mitteilung = 0;
cooldown2 = 0;
cooldown3 = 0;
...
function backgroundCOLOR4() {
    document.getElementById("ErrorAlert").style.backgroundColor = "rgb(70, 168, 245)";
    document.getElementById("myBar").style.backgroundColor = "rgb(70, 140, 220)";
    document.getElementById("myProgress").style.backgroundColor = "rgb(70, 168, 245)"; 
}
...
document.getElementById("fname").addEventListener("keyup", function(event) {
    ...
    if (benutzernameINPUT !== "") {
        if (passwortINPUT !== "") {
            if (passwortINPUTwdh !== "") {
                if (kuerzelINPUT !== "") {
                        document.getElementById("submit1").style.backgroundColor = "rgb(0, 237, 100)";
                        regestrierenDARF = 1;
                        console.log("REG1: "+regestrierenDARF)
                }
            }
        }
    }
        ...
        if (benutzernameINPUT !== "") {
            if (passwortINPUTwdh !== "") {
                if (kuerzelINPUT !== "") {
                    document.getElementById("submit1").style.backgroundColor = "rgb(0, 237, 100)";
                    regestrierenDARF = 1;
                    console.log("REG2: "+regestrierenDARF)
                }
            }
        }
    }
...
document.getElementById("passwortWDH").addEventListener("keyup", function(event) {
    var benutzernameINPUT = document.getElementById("fname").value;
    var passwortINPUT = document.getElementById("passwort").value;
    var passwortINPUTwdh = document.getElementById("passwortWDH").value;
    var kuerzelINPUT = document.getElementById("kuerzel").value;
        ...
        if (benutzernameINPUT !== "") {
            if (passwortINPUT !== "") {
                if (kuerzelINPUT !== "") {
                        document.getElementById("submit1").style.backgroundColor = "rgb(0, 237, 100)";
                        regestrierenDARF = 1;
                        console.log("REG3: "+regestrierenDARF)
                }
            }
        }
    }
        ...
        if (benutzernameINPUT !== "") {
            if (passwortINPUT !== "") {
                if (passwortINPUTwdh !== "") {
                    document.getElementById("submit1").style.backgroundColor = "rgb(0, 237, 100)";
                    regestrierenDARF = 1;
                    console.log("REG4: "+regestrierenDARF)
                }
            }
        }
    }
            ...
            if (passwortINPUT !== "") {
                if (passwortINPUTwdh !== "") {
                    if (kuerzelINPUT !== "") {
                        document.getElementById("submit1").style.backgroundColor = "rgb(0, 237, 100)";
                        regestrierenDARF = 1;
                        console.log("REG5: "+regestrierenDARF)
                    }
                }
            }
        }
...
function check() {
    console.log("REG6: "+regestrierenDARF);
    console.log("REG7: "+regestrierenDARF);
    var kuerzelINPUT = document.getElementById("kuerzel").value;
    console.log(kuerzelINPUT);
    kuerzelINPUTrichtigf = 0;
    console.log(kuerzelINPUTrichtigf);

    if (kuerzelINPUT.length >= 2) {
        check4();
        console.log("Kein Kuerzel");
        kuerzelINPUTrichtigf == 1;
    }
    else {
        console.log(kuerzelINPUTrichtigf);
        kuerzelINPUTfalsch();
        console.log("input falsch");
        return;
    }
}
...
function check3() {
    ...
    if (passwortINPUTwdh == 0) {
        document.getElementById("passwortWDH").style.border = "1px solid red";
    }
    if (kuerzelINPUT == 0) {
        document.getElementById("kuerzel").style.border = "1px solid red";
    }
    if (benutzernameINPUT.length == 0 || passwortINPUT.length == 0 || passwortINPUTwdh.length == 0 || kuerzelINPUT.length == 0) {
        nichtAusgefuellt()
    }
    if (benutzernameINPUT.length !== 0) {
        document.getElementById("fname").style.border = "1px solid black";
...
function kuerzelINPUTfalsch() {
    ...
    move()
    playAudio3()
    mitteilungINSERT(mittelungGRUND = "Falscher Klassenkürzel", warnstufe = "Warnung");
}

function noticeINPUTemail() {
    document.getElementById("alertError").innerHTML = "Info: Eine Emal ist optional, jedoch Wichtig bei einer Passwort zurücksetzung";
    if (timer == 1) {
        playAudio4();
        backgroundCOLOR4();
        alertBoxVISIBLE();
        move();
        mitteilungINSERT(mittelungGRUND = "Info: Eine Emal ist optional, jedoch Wichtig bei einer Passwort zurücksetzung", warnstufe = "Information");
        timer = 0;
        setTimeout(() => {
            timerreset()
        }, 10000);
...
function passwortNichtGleich() {
    ...
    move()
    playAudio3()
    mitteilungINSERT(mittelungGRUND = "Passwörter sind nicht gleich!", warnstufe = "Warnung");
}
...
function nichtAusgefuellt() {
    ...
    move()
    playAudio3()
    mitteilungINSERT(mittelungGRUND = "Nicht alle Registrierdaten ausgefüllt", warnstufe = "Warnung");
}
...
function DatenbankFehler() {
    document.getElementById("alertError").innerHTML = "Error 500, Internal Server Error: Datenbankfehler";
    backgroundCOLOR()
    alertBoxVISIBLE()
    move()
    playAudio()
    mitteilungINSERT(mittelungGRUND = "Error 500, Unbekannter Server Datenbankfehler", warnstufe = "Kritisch");
}

function BenutzernameExestiertBEREITS() {
    document.getElementById("alertError").innerHTML = "Der Benutzername ist bereits vergeben";
    backgroundCOLOR2()
    alertBoxVISIBLE()
    move()
    playAudio3()
    mitteilungINSERT(mittelungGRUND = "Benutzername ist bereits vergeben", warnstufe = "Warnung");
    document.getElementById("fname").style.border = "1px solid red";
}

function EmailExestiertBEREITS() {
    document.getElementById("alertError").innerHTML = "Die E-Mail ist bereits vergeben";
    backgroundCOLOR2()
    alertBoxVISIBLE()
    move()
    playAudio3()
    mitteilungINSERT(mittelungGRUND = "E-Mail ist bereits vergeben", warnstufe = "Warnung");
}

function PasswortZuKurz() {
    document.getElementById("alertError").innerHTML = "Das Passwort ist zu kurz, minimum 8 Buchstaben / Zahlen";
    backgroundCOLOR2()
    alertBoxVISIBLE()
    move()
    playAudio3()
    mitteilungINSERT(mittelungGRUND = "Passwort ist zu kurz!", warnstufe = "Warnung");
    document.getElementById("passwort").style.border = "1px solid red";
}
...
function PasswortIstPflicht() {
    ...
    move()
    playAudio3()
    mitteilungINSERT(mittelungGRUND = "Passwort ist Pflicht", warnstufe = "Warnung");
    document.getElementById("passwort").style.border = "1px solid red";
}

function PasswortZuLang() {
    document.getElementById("alertError").innerHTML = "Das Passwort ist zu Lang, maximal 40 Zeichen sind erlaubt";
    backgroundCOLOR2()
    alertBoxVISIBLE()
    move()
    playAudio3()
...
function BenutzernameIstPflicht() {
    ...
    move()
    playAudio3()
    mitteilungINSERT(mittelungGRUND = "Benutzername ist Pflicht", warnstufe = "Warnung");
    document.getElementById("fname").style.border = "1px solid red";
}

function BenutzernameZuLang() {
    document.getElementById("alertError").innerHTML = "Der Benutzername ist zu Lang, maximal 40 Zeichen sind erlaubt";
    backgroundCOLOR2()
    alertBoxVISIBLE()
    move()
    playAudio3()
...
function BenutzernameZuKurz() {
    document.getElementById("alertError").innerHTML = "Der Benutzername ist zu kurz, minimum 6 Zeichen";
    backgroundCOLOR2()
    alertBoxVISIBLE()
    move()
    playAudio3()
...
function EmailZuLang() {
    document.getElementById("alertError").innerHTML = "Die Email ist zu Lang, maximal 40 Zeichen sind erlaubt";
    backgroundCOLOR2()
    alertBoxVISIBLE()
    move()
    playAudio3() 
    mitteilungINSERT(mittelungGRUND = "E-Mail ist zu lang!", warnstufe = "Warnung");
    document.getElementById("email").style.border = "1px solid red";
}

function RegestrierungERFOLG() {
    document.getElementById("alertError").innerHTML = "Erfolg, Account wurde Registriert! Weiterleitung zur Anmeldung in kürze...";
    linkEHRE = 1;
    backgroundCOLOR3()
    alertBoxVISIBLE()
    move()
...
function regestrierenVERSCHICKEN() {
    ...
    fetch('http://localhost:3000/mysql/regestrieren', { headers: { 
...
function mitteilungINSERT(mittelungGRUND, warnstufe) {
    ...
    if (cooldown3 == 0) {
        ...
        if (mitteilung == 1) {
            ...
            if (warnstufe !== "Warnung" && warnstufe !== "Information" && warnstufe !== "Kritisch") {
