...
// Verbindungs Icon:
    // Nicht Verbunden
        function HserverConErr() {
            document.getElementById("H:Server").src = "Xicon.png"
            HsqlConErr()
        }

        function HsqlConErr() {
            document.getElementById("H:Datenbank").src = "Xicon.png"
            NsqlConErr()
        }

        function NsqlConErr() {
            document.getElementById("N:Datenbank").src = "Xicon.png"
        }
    // Verbunden
        function HserverCon() {
            document.getElementById("H:Server").src = "GrünerHaken2.png"
        }

        function HsqlCon() {
            document.getElementById("H:Datenbank").src = "GrünerHaken2.png"
        }

        function NsqlCon() {
            document.getElementById("N:Datenbank").src = "GrünerHaken2.png"
        }
...
document.getElementById("exitICON3").addEventListener("click", function(event) {
    infoOFalertsHINWEG2()
})

document.getElementById("ServerConnectionVis").addEventListener("click", function(event) {
    infoOFalertsHERVOR2();
})
...
// Account Readen:
var stored = localStorage['AnmeldeDatenSchlüsselAbgespeichert'];
if (stored) AbgespeicherteAnmeldeDaten = JSON.parse(stored);
else AbgespeicherteAnmeldeDaten = {benutzername: "Not Authorized", passwort: "Not Authorized", kuerzel: "Not Authorized"};
console.log("Data;",AbgespeicherteAnmeldeDaten);